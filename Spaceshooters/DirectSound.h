...
#define DSUtil_StopSound(s)         { if(scale) scale->Stop(); }
#define DSUtil_PlaySound(s)         { if(scale) scale->Play( 0, 0 ); }
#define DSUtil_PlaySoundLooping(s)  { if(scale) scale->Play( 0, DSBPLAY_LOOPING ); }
